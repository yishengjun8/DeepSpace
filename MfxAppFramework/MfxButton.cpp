...
void MicroFlakeX::MfxButton::RegDefFunc()
{
	...
	CONTROL_REG_MSG(MfxUI_Message_PaintImage, MfxButton, OnPaintCoverImage, myCoverFloor);
	CONTROL_REG_MSG(MfxUI_Message_PaintImage, MfxButton, OnPaintUnderImage, myUnderFloor);
...
MicroFlakeX::MfxReturn MicroFlakeX::MfxButton::OnPaintCoverImage(WPARAM wParam, LPARAM lParam)
{
	MfxCodeLock t_CodeLock(this);
...
MicroFlakeX::MfxReturn MicroFlakeX::MfxButton::OnPaintUnderImage(WPARAM wParam, LPARAM lParam)
{
	MfxCodeLock t_CodeLock(this);
