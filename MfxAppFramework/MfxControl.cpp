...
void MicroFlakeX::MfxControl::MfxRegMessages()
{
	...
	CONTROL_REG_MSG(MfxUI_Message_PaintTexture, MfxControl, __OnPaintTexture, myCoverFloor);
	CONTROL_REG_MSG(MfxUI_Message_PaintImage, MfxControl, __OnPaintImage, myCoverFloor);
...
MicroFlakeX::MfxReturn MicroFlakeX::MfxControl::__OnPaintTexture(WPARAM wParam, LPARAM lParam)
{
	MfxCodeLock t_CodeLock(this);
	return MfxFine;
}

MicroFlakeX::MfxReturn MicroFlakeX::MfxControl::__OnPaintImage(WPARAM wParam, LPARAM lParam)
{
	MfxCodeLock t_CodeLock(this);
	if (myBackImage)
	{
