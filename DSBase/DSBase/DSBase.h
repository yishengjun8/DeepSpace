...
#define DSOBJECT_AUTOFUNC_REG(func, id) __DSOBJECT_AUTOFUNC_REG(func, id) 
...
using DeepSpace::obj;\
std::map<DSStr, unsigned int> DSAutoFuncMap;\
typedef std::map<DSStr, unsigned int>::value_type DSAutoFuncValue;\
...
auto obj##Hand = new DSBaseTest00FactoryHand(L#obj);\
...
#define __DSOBJECT_AUTOFUNC_REG(func, id) \
DSAutoFuncMap.insert(DSAutoFuncValue(L#func, id));
